...
const Medicinal: React.FC = () => {
  const imagens = [
    require('../../assets/Imagens/medicinal/imagem1.png'),
    require('../../assets/Imagens/medicinal/imagem2.png'),
    require('../../assets/Imagens/medicinal/imagem3.png'),
    require('../../assets/Imagens/medicinal/imagem4.png'),
  ...
  return (
    <ScrollView style={styles.container}>
        <Text style={styles.titulo}>{TextosInicio.tituloCard}</Text>
